...
const testimonialData: TestimonialData[] = [
  ...
  },
  {
    ...
    gridArea: 'col-span-1 row-start-2',
    reducedPadding: true,
  },
  {
    ...
    gridArea: 'col-span-2 row-start-2',
    reducedPadding: true,
  ...
  },
  {
    ...
    textColor: 'text-dark-grayish-blue',
    backgroundColor: 'bg-white',
    gridArea: 'col-start-4 row-span-2',
    reducedPadding: true,
  },
];
...
export default function Home() {
  return (
    <main className="flex justify-center items-center w-screen h-screen bg-light-grayish-blue">
      <section className="grid grid-cols-4 grid-rows-[auto_auto] gap-x-[30px] gap-y-6 max-w-[1110px]">
